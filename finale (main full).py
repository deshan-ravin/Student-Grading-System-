...
choice= ''
while choice!='q':                     #main outer loop
    choice=str(input('Enter "s" for student mode,"t" for staff mode or "q" to quit:'))
    print()
    if choice=='t':
        ...
        while repeat=='y':            # inner loop for repeating staff mode process
            ...
            if total==120:
                ...
                if creditpass==120 and defer==0 and fail==0:                      #progress credit check
                    ...
                    credit_level_check('Progress (Module trailer)')
    ...
    elif choice=='q':               #Ending program on 'q'
